    ...
    <div class="container">
        <div class="banner__product">
            <ul>
                ...
                <li>/</li>
                <li class="active">Danh mục :<?php echo isset($category['name']) ? $category['name'] : "Hàng mới về" ?></li>
            </ul>
        </div>
    </div>
        ...
        <?php foreach ($products as $product):
            ...
            <div class="hot-product1">
                ...
                <div>
                    ...
                    <?php if ($product['discount'] > 0): ?>
                        <p><span
                                    class="price-label"><?php echo number_format($product["price"] - ($product["price"] * ($product["discount"] / 100))); ?>
                                ₫</span> &nbsp <span
                                    class="price "><?php echo number_format($product["price"]); ?> ₫</span>
                        </p>
                    <?php else: ?>
