...
<div class="slider">
    <div class="container">
        <div class="row">
            ...
            ?>
            <div class="banner-right" style="margin-bottom: 50px">
                <div class="container" >
                    <div class="banner__product">
                        <ul>
                            <li><a href="index.php"> Trang chủ</a></li>
                            <li>/</li>
                            <li class="active">Thương hiệu : <?php echo $producer["name"]; ?><a href=""></a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        foreach ($products as $product):
                            ...
                            <div class="hot-product1">
                                ...
                                <div>
                                    ...
                                    <?php if($product['discount'] > 0): ?>
                                        <p><span class="price"><?php echo number_format($product["price"]-($product["price"]*($product["discount"]/100))); ?> ₫</span> &nbsp <span
                ...
                <div style="text-align: center;margin: 40px auto">Thương hiệu này không có sản phẩm nào !!!</div>
                <?php endif; ?>
            </div>
